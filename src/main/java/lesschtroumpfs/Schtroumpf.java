...
public class Schtroumpf {
	...
	/*la methode isContent retourne l'état de joie du schtroumpf
	 * @return content
	 * 
	 */
	...
	/**
	 * Méthode permettant de donner à manger au schtroumpf -> impacte leur etat "content"
	 * @param pfQte
	 */
	public void manger(int pfQte) {
		if (pfQte < 0) {
			...
			this.content = true;
			System.out.println(nom+" est très content");
		}
	}
	
	/*
	 * Méthode envoyant les shctroumpf au travail -> impacte leur etat "content"
	 */
